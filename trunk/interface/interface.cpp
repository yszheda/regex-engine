...
{
	//InitializeSkin("Gloss.ssk"); //加载皮肤
	//skinppLoadSkin("Steel.ssk");			//加载皮肤 && 动态换肤
	//skinppLoadSkin("dogmax.ssk");			//加载皮肤 && 动态换肤
	//skinppLoadSkin("MAC.ssk");			//加载皮肤 && 动态换肤
	skinppLoadSkin("xp_corona.ssk");			//加载皮肤 && 动态换肤
